...
public:
	...
	void DisplayTextDebug(const string& Text, u32 uXpos, u32 uYpos, u8 Alpha) const;
	void DisplayTextScaled(const string& Text, u32 uXpos, u32 uYpos,float Scale=1.0f,u8 Alpha=0xff) const;
