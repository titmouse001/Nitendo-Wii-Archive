...
//////////
//////////
//////////void main2( char* pFileName) //int argc, char *argv[] )
//////////{
//////////   float t1, t2;
//////////   unsigned int failID;
//////////   int failpos;
...
//////////
//////////	if ( !testload( pFileName, &failID, &failpos )) 
//////////	{
//////////          printf( "%s\nLoading failed near byte %d\n\n", pFileName, failpos );
//////////    }
//////////
...
//////////
//////////   printf( "------------------\n%8d objects", nobjects );
//////////   printf( "%8d layers", nlayers );
//////////   printf( "%8d surfaces", nsurfs );
//////////   printf( "%8d envelopes", nenvs );
//////////   printf( "%8d clips", nclips );
//////////   printf( "%8d points", npoints );
//////////   printf( "%8d polygons\n", npolygons );
//////////   printf( "%g seconds", t2 );
//////////}
