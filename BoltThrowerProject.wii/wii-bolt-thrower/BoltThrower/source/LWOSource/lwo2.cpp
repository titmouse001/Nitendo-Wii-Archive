...
====================================================================== */
 ...
 //typedef void (__clrcall * PROC99)(void *); 
      ...
      switch ( id )
      {
         case ID_LAYR:
            if ( object->nlayers > 0 ) {
               layer = (lwLayer*)calloc( 1, sizeof( lwLayer ));
               if ( !layer ) goto Fail;
               lwListAdd( (void**) &object->layer, (void*) layer );
            }
            object->nlayers++;
         ...
         case ID_VMAD:
            ...
            if ( !node ) goto Fail;
            lwListAdd( (void**) &layer->vmap, (void*) node );
            layer->nvmaps++;
            break;
         ...
         case ID_ENVL:
            ...
            if ( !node ) goto Fail;
            lwListAdd( (void**) &object->env,(void*)  node );
            object->nenvs++;
            break;
         ...
         case ID_CLIP:
            ...
            if ( !node ) goto Fail;
            lwListAdd((void**)  &object->clip, (void*) node );
            object->nclips++;
            break;
